...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        ...
        # audio_file = audio.LocalAudioFile('moonlight sonata.mp3')
        ...
        # queryGMM = modelA
        # # queryTimbre = modelA.sample(10000)
        # # Try this thing later vvv
        # queryTimbre = timbreA
        ##############################################

        # By HDF5 File Name
        gmm = pickle.load(open('TRBGGYE128F42B63ABGMM.p', 'rb'))
        queryGMM = gmm
